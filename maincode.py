...
def generate_certificate(name, date, course, selected_company, course_provider="Coursera", instructor_name=None, logo_path=None):
    if course_provider == "Coursera":
        ...
        # Add custom fonts
        pdfmetrics.registerFont(TTFont('Gunaydin', r'C:\Users\prane\Downloads\certificate_generator_one\certificate_generator\fonts\Gunaydin-Regular.ttf'))
        pdfmetrics.registerFont(TTFont('TimesNewRomanBold', r'C:\Users\prane\Downloads\certificate_generator_one\certificate_generator\fonts\times-new-roman-bold.otf'))
        pdfmetrics.registerFont(TTFont('Touche', r'C:\Users\prane\Downloads\certificate_generator_one\certificate_generator\fonts\Touche-Semibold-BF642a2ebf682d9.otf'))
